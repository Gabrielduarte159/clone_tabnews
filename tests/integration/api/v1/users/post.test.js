...
describe("POST /api/v1/users", () => {
  describe("Anonymous user", () => {
    test("Wish unique and valid data", async () => {
    ...
    test("Wish duplicated 'email'", async () => {
    ...
    test("Wish duplicated username", async () => {
      const response1 = await fetch("http://localhost:3000/api/v1/users", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      expect(response2Body).toEqual({
        ...
        action: "Utilize username email para realizar o cadastro.",
        status_code: 400,
      });
    });
  });
